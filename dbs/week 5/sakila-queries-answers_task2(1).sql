...
#Note: On remote CSCT server, you may not be able to perform some DDL statemements due to restrictions on database accounts
/* Source: https://github.com/sschadt/sakila */
